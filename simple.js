...
ppuser = 'https://file.hikki.me/uploads/1k17463rqs.jpeg'
}
// Get Profile Picture Group
try {
ppgroup = await conn.profilePictureUrl(anu.id, 'image')
} catch {
ppgroup = 'https://file.hikki.me/uploads/1k17463rqs.jpeg'
}
...
if (anu.action == 'add') {
teks = `Selamat Datang Lord Terhormat Di *${metadata.subject}* ${num.split("@")[0]}\n\nJangan Baperan Yah Soalnya Ini Bukan Ajang Percintaan🥴🤙`
...
"hydratedFooterText": `© LordNekell`,
"hydratedButtons": [
{
"urlButton": {
"displayText": namaweb,
"url": `https://cirebonxploit.tech/`
}
},
{
"callButton": {
"displayText": "C O N T A C T",
...
conn.relayMessage(anu.id, buatpesan.message, { messageId: buatpesan.key.id })
} else if (anu.action == 'remove') {
tekx = `𝐘𝐚𝐡 𝐊𝐨𝐤 𝐊𝐞𝐥𝐮𝐚𝐫 𝐃𝐚𝐫𝐢 *${metadata.subject}*, 𝐉𝐚𝐧𝐠𝐚𝐧 𝐋𝐮𝐩𝐚 𝐁𝐚𝐰𝐚 𝐆𝐨𝐫𝐞𝐧𝐠𝐚𝐧 𝐊𝐚𝐥𝐚𝐮 𝐁𝐚𝐥𝐢𝐤 ${num.split("@")[0]} 😆`
var left = generateWAMessageFromContent(m.chat, {
"templateMessage": {
"hydratedTemplate": {
"locationMessage": {
"degreesLatitude": 0,
...
{
"quickReplyButton": {
"displayText": "𝐁𝐞𝐛𝐚𝐧 𝐚𝐤𝐡𝐢𝐫𝐧𝐲𝐚 𝐤𝐞𝐥𝐮𝐚𝐫 𝐛𝐞𝐞😆",
"id": `.nice`
}
}
]
...
conn.relayMessage(anu.id, left.message, { messageId: left.key.id })
} else if (anu.action == 'promote') {
conn.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} Promote From ${metadata.subject}` })
} else if (anu.action == 'demote') {
conn.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} Demote From ${metadata.subject}` })
}
}
} catch (err) {
console.log(err)
